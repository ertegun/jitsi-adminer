    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex h-dvh w-full has-[[data-variant=inset]]:bg-sidebar overflow-hidden",
            className
          )}
          ref={ref}
          {...props}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      style={{
        marginLeft: !isMobile && state === "expanded" ? "var(--sidebar-width)" : "0",
        height: "100dvh",
      }}
      className={cn(
...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    asChild?: boolean
    isActive?: boolean
    tooltip?: string | React.ComponentNode
